...
@Component
public class TikTokContentProvider extends AbstractYtDlpProvider {

    public TikTokContentProvider(ObjectMapper objectMapper,
    ...
    public boolean supports(String url) {
        return host(url).contains("tiktok.com");
    }
}
